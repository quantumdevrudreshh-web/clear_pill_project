...
class _DrugscannerState extends State<Drugscanner> {
  ...
  List<Widget> get _pages => [
    DrugScannerBody(color: color, weight700: weight700, fontFamily: fontFamily),
...
class DrugScannerBody extends StatefulWidget {
  ...
  const DrugScannerBody({super.key, required this.color, required this.weight700, required this.fontFamily});
